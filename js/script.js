...
function paymentStatus(status) {
  ...
  if (status === "success") {
    ...
    const invoiceHTML = `
        <div class="invoice-cont">
            ...
            <div class="invoice-details">
                ...
                <p><strong>Course:</strong>B.E ( Computer Science Engineering )</p> 
    ...
    // Payment failed, show alert with the message
    alert("Make a successful payment to generate an invoice.", "Try Again");
...
function printInvoice() {
  ...
  printWindow.document.write(
    "<html><head><title>Invoice</title>" + printStyles + "</head><body>"
  );
  printWindow.document.write(
    '<div id="invoiceContainer">' + invoiceContent + "</div>"
  );
